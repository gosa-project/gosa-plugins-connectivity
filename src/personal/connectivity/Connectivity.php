    ...
    function execute()
    {
        ...
        if ($this->parent === NULL) {
            ...
            if (!$enabled) {
                ...
                $display = "<div class='valign-wrapper'>" . $symbol . msgPool::noValidExtension(__("")) . "</div>";
        ...
        $display .= "<div class='connectivity-wrapper'>";
        $display .= "<h2>" . __("Preferences") . "</h2>";
   ...
   */
    ...
    static function plInfo()
    {
        return (array(
            ...
            "plDescription"       => __("Connectivity add-on"),
            "plSelfModify"        => TRUE,
